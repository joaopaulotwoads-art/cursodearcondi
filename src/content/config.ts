...
const siteSettings = defineCollection({
    ...
    schema: z.object({
        siteName: z.string(),
        /** Tema visual do site p√∫blico (pastas em src/themes/ e singletons). */
        ...
        // Pexels API ‚?? imagens em posts gerados por IA (1 a cada ~400 palavras, m√°x 5)
        pexelsApiKey: z.string().optional(),
        // SEO T√©cnico ‚?? sempre apex https:// sem www (igual Vercel)
        canonicalUrl: z
            .string()
            .optional()
            .transform((val) => {
        ...
        // Contato centralizado ‚?? usado em Header, Footer, p√°ginas locais, schema JSON-LD
        companyPhone: z.string().optional(),
        companyWhatsapp: z.string().optional(),
        // Atualiza√ß√µes autom√°ticas do template (workflow .github)
